function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegationResponsive)}function navegationResponsive(){document.querySelector(".navigation").classList.toggle("show")}
